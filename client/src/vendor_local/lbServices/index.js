  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Project#prototype$__get__task
         * @methodOf lbServices.Project
         * @deprecated Use project.task() instead.
         *
         * @description
         *
         * Queries task of project.
         *
        ...
        "prototype$__get__task": {
          url: urlBase + "/projects/:id/task",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Project#prototype$__create__task
         * @methodOf lbServices.Project
         * @deprecated Use project.task.create() instead.
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Project#prototype$__delete__task
         * @methodOf lbServices.Project
         * @deprecated Use project.task.destroyAll() instead.
         *
         * @description
         *
         * Deletes all task of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*=}` - PersistedModel id
        ...
        R.task = function() {
          ...
          var action = TargetResource["::get::project::task"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Project#task.create
         * @methodOf lbServices.Project
         * @deprecated Use project.task.create() instead.
         *
         * @description
        ...
        R.task.create = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::create::project::task"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Project#task.destroyAll
         * @methodOf lbServices.Project
         * @deprecated Use project.task.destroyAll() instead.
         *
         * @description
         ...
         * This method returns no data.
         */
        R.task.destroyAll = function() {
          var TargetResource = $injector.get("Task");
          var action = TargetResource["::delete::project::task"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use project.task() instead.
        "::get::project::task": {
          url: urlBase + "/projects/:id/task",
          method: "GET",
        },

        // INTERNAL. Use project.task.create() instead.
        "::create::project::task": {
          url: urlBase + "/projects/:id/task",
          method: "POST",
        },

        // INTERNAL. Use project.task.destroyAll() instead.
        "::delete::project::task": {
          url: urlBase + "/projects/:id/task",
          method: "DELETE",
        },
