...
exports.config = {
  ...
  specs: [
    // 'spec/*_spec.js',
    // 'dummy/*.js',
    // 'ng-modules/**/test/scenarios/*.coffee'
    '../client/src/ng-modules/**/test/e2e/*.coffee' // use --specs path/to/file.coffee for single tests
  ],
  ...
  onPrepare: function() {
    ...
    global.By = protractor.By; // "by" in .coffee documents causes error because it's a reserved keyword
    global.findEl = function(locator){
